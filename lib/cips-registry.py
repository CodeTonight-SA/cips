...
CLI:
    python3 cips-registry.py register   # Register and print branch
    python3 cips-registry.py deregister # Remove session lock
    python3 cips-registry.py status     # List active sessions
