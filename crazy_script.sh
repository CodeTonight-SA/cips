...
#
# USAGE:
#   ./crazy_script.sh detect          # Run pattern detection
#   ./crazy_script.sh audit           # Run efficiency audit
#   ./crazy_script.sh generate        # Generate skill from pattern
#   ./crazy_script.sh optimize        # Meta-optimization (recursion)
#   ./crazy_script.sh cycle           # Full improvement cycle
#   ./crazy_script.sh create-agents   # Auto-detect and create agents
...
EXAMPLES:
    ...
    ./crazy_script.sh diagnose           # Troubleshoot history path issues
    ./crazy_script.sh lint-bash          # Lint bash scripts for readonly bugs
